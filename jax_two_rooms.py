...
class JaxTwoRoomsRollout:
    ...
    Planned actions cross directly from Torch to JAX through DLPack and the
    three small outputs cross back the same way.
    """
    ...
    def _validate_cuda_packages() -> None:
        ...
        if installed and installed != [expected]:
            ...
            raise RuntimeError(
                ...
                f'stable-worldmodel[manyworlds-jax-cuda{expected}] to avoid '
                'cuDNN sublibrary conflicts.'
            )
